  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:
            ...
            //Agrege el mismo boton que forodart para agregar post de los comentarios
floatingActionButton: FloatingActionButton.extended(
 onPressed: () {
   Navigator.push(
     context,
     MaterialPageRoute(builder: (context) => NewComentForm()),
   );
 },
 label: Text('Agregue sus comentarios aqui'),
